...
Krishna = (dict1['maths']+dict1['physics']+dict1['chemistry'])/3
Arjun = (dict2['maths']+dict2['physics']+dict2['chemistry'])/3
Malika = (dict3['maths']+dict3['physics']+dict3['chemistry'])/3
print "Number of students is 3"
